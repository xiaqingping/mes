...
export default {
  ...
  changeContactInfoNewEmailVerifyCodeSendingVerify(verifyRecordId, data) {
    return request(`/businessPartners/v1/verifyRecords/${verifyRecordId}/changeContactInfo/newEmailVerifyCodeSending`, { method: 'POST', data });
  },
  ...
  changeContactInfoNewEmailVerifyCodeVerificationVerify(verifyRecordId, data) {
    return request(`/businessPartners/v1/verifyRecords/${verifyRecordId}/changeContactInfo/newEmailVerifyCodeVerification`, { method: 'POST', data });
  },
};
