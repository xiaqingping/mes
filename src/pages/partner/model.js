    ...
    DefaultInvoiceType: [
      {
        id: '10',
        name: '增值税专用发票',
        i18n: 'bp.maintain_details.sales_distribution.vat_specific_invoice',
      },
      {
        id: '20',
        name: '增值税普通发票',
        i18n: 'bp.maintain_details.sales_distribution.vat_free_text_invoice',
      },
    ],
    // 其他国家默认开票类型
    DefaultInvoiceTypeOther: [
      {
        id: '0',
        name: '免税',
        i18n: 'bp.maintain_details.sales_distribution.tax_exemption',
      },
      {
        id: '1',
        name: '必须上税',
        i18n: 'bp.maintain_details.sales_distribution.must_be_taxed',
      },
    ],
    // 邮箱认证状态
    EmailVerifyStatus: [
