      ...
      <Card
        ...
        >
          <DescriptionsItem span={2} label="名称">
            ...
            &nbsp;&nbsp;{basic.name}&nbsp;&nbsp;&nbsp;<a>变更</a></DescriptionsItem>
          <DescriptionsItem span={2} label="移动电话">
            ...
            {basic.mobilePhone}&nbsp;&nbsp;&nbsp;
            <a onClick={() => { this.checkPhone(true) }}>变更</a></DescriptionsItem>
          <DescriptionsItem span={2} label="邮箱">
            {basic.email}&nbsp;&nbsp;&nbsp;
            <a onClick={() => { this.checkEmail(true) }}>变更</a></DescriptionsItem>
          <DescriptionsItem span={2} label="电话"><img src={Flag} width="10" height="10"
          style={{ borderRadius: '50%', marginBottom: '3px' }}/>
          &nbsp;&nbsp;{basic.telephoneCountryCode}&nbsp;&nbsp;
          {basic.telephoneAreaCode}{basic.telephone ? `-${basic.telephone}` : ''}
          {basic.telephoneExtension ? `-${basic.telephoneExtension}--` : ''}
          &nbsp;&nbsp;&nbsp;<a>变更</a></DescriptionsItem>
          <DescriptionsItem span={2} label="传真">
            <img src={Flag} width="10" height="10"
            style={{ borderRadius: '50%', marginBottom: '3px' }}/>
            &nbsp;&nbsp;{basic.faxCountryCode}&nbsp;&nbsp;
            {basic.faxAreaCode}{basic.fax ? `${basic.fax}-` : ''}
            {basic.faxExtension ? `${basic.faxExtension}-` : ''}</DescriptionsItem>
          ...
          <DescriptionsItem span={2} label="特性行业类别">
            {basic.industryCode}&nbsp;&nbsp;&nbsp;<a>变更</a></DescriptionsItem>
