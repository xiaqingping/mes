...
import { InboxOutlined, PaperClipOutlined, LeftOutlined, RightOutlined } from '@ant-design/icons';
...
class UploadSequenceFile extends React.Component {
  ...
  deleteFiles = v => {
    ...
    //   console.log(item);
    //   const result = item.sampleProperties.filter(i => i.sourceSequenceFileId !== v.fileId);
    //   console.log(index);
    //   if (result.length !== 0) {
    //     tableList[index].sampleProperties = result;
    //   } else {
    //     console.log(tableList.splice(index, 1));
    //   }
    // });
