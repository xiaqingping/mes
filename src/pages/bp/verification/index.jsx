    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ lg: 24, md: 12, sm: 6 }}>
          ...
          <Col lg={6} md={8} sm={12}>
            <FormItem label="类型">
              {getFieldDecorator('type')(
                <Select placeholder="请选择" optionLabelProp="label">
          ...
          <Col lg={6} md={8} sm={12}>
            <FormItem label="状态">
              {getFieldDecorator('statusList')(
                <Select mode="multiple" placeholder="请选择" optionLabelProp="label">
          ...
          <Col lg={6} md={8} sm={12}>
            <FormItem label="完成时间">{getFieldDecorator('finishTime')(<RangePicker />)}</FormItem>
          </Col>
          <Col lg={6} md={8} sm={12}>
            <FormItem label="过期时间">
          ...
          <Col lg={6} md={8} sm={12}>
            <FormItem label="审核人">
              {getFieldDecorator('approverCode')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>
        </Row>
    ...
    const columns = [
      {
        ...
        render(value, record) {
          return (
            <>
              <div>{value}</div>
              <div>{record.operationRecordCode}</div>
            </>
          );
        },
      },
          ...
          return (
            <>
              <div className={styles.partName}>
                <Icon type="user" /> <span>{record.bpName}</span>
              </div>
      ...
      },
      {
        ...
        render(value, record) {
          return (
            <>
              <div>{value}</div> <div>{record.operationDate}</div>
            </>
          );
        },
      },
