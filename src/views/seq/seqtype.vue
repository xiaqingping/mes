  ...
  methods: {
    ...
    setColumn () {
      ...
      const columns = [
        ...
        { title: '结果类型', field: 'resultType', editRender: { name: 'input' } },
        { title: '分析程序', field: 'appServer', editRender: { name: 'input' } },
        { title: '分析参数', field: 'appInstance', editRender: { name: 'input' } },
        { title: '分析下载附件命名规则', field: 'reactionResultNameRule', editRender: { name: 'input' } },
        { title: '订单下载附件命名规则', field: 'orderResultNameRule', editRender: { name: 'input' } },
        { title: '反应上机命名规则', field: 'reactionStartNameRule', editRender: { name: 'input' } },
        { title: '上机结果组', field: 'resultGroup', editRender: { name: 'input' } },
        { title: '仪器协议', field: 'instrumentProtocol', editRender: { name: 'input' } },
        { title: '分析协议', field: 'analysisProtocol', editRender: { name: 'input' } },
