  ...
  methods: {
    ...
    setColumn () {
      ...
      const columns = [
        ...
        { title: '结果类型', field: 'resultType', editRender: { name: 'AInput' } },
        { title: '分析程序', field: 'appServer', editRender: { name: 'AInput' } },
        { title: '分析参数', field: 'appInstance', editRender: { name: 'AInput' } },
        { title: '分析下载附件命名规则', field: 'reactionResultNameRule', editRender: { name: 'AInput' } },
        { title: '订单下载附件命名规则', field: 'orderResultNameRule', editRender: { name: 'AInput' } },
        { title: '反应上机命名规则', field: 'reactionStartNameRule', editRender: { name: 'AInput' } },
        { title: '上机结果组', field: 'resultGroup', editRender: { name: 'AInput' } },
        { title: '仪器协议', field: 'instrumentProtocol', editRender: { name: 'AInput' } },
        { title: '分析协议', field: 'analysisProtocol', editRender: { name: 'AInput' } },
