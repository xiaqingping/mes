...
<template>
  <div class="page-content">
    ...
    <vxe-grid
      highlight-hover-row
      auto-resize
      :ref="sampleTypeTable.ref"
      :loading="sampleTypeTable.loading"
      :columns="sampleTypeTable.columns"
      :pager-config="sampleTypeTable.pagerConfig"
      :data.sync="sampleTypeTable.tableData"
      :edit-rules="sampleTypeTable.editRules"
  ...
  methods: {
    ...
    setColumn () {
      ...
      const columns = [
        ...
        { label: '简写', prop: 'alias', editRender: { name: 'input' } },
    ...
    handleSearch () {
      ...
      this.$api.sampletype.getSampleType(params, true).then((data) => {
