  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return this.$api.reaction.getSeqresults(params, true).then(res => {
          return {
            data: res.rows,
            page: params.page,
            total: res.total
  ...
  methods: {
    createColumnDefs () {
      ...
      this.columns = [
        ...
        { title: '项目号', dataIndex: 'orderDetailCode' },
        ...
        { title: '测序结果', dataIndex: 'result' },
        { title: '结果', dataIndex: 'resutlPath' },
        { title: '分析结果', dataIndex: 'targetResultPath' },
        { title: '压缩', dataIndex: 'compression' },
        { title: '优化', dataIndex: 'beautification' },
